package com.excel.lianxi.excel.xml;
...
/**
 * @auther: zxl
 * @Date: 2021/3/19 09:38
 * @Description:解析xml到excel
 */
public class CreteTemplate {

    public static void main(String[] args) {
        //获取解析xml文件路径
        String path = System.getProperty("user.dir") + "\\src\\main\\java\\com\\zxl\\demo\\xml\\student.xml";
...
//						font.setFontHeight((short)12);
            ...
            //生成Excel导入模板
            File tempFile = new File("E:\\excel\\" + templateName + ".xls");
            tempFile.delete();
